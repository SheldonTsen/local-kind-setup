#!/bin/sh
# taken and adapted from: https://kind.sigs.k8s.io/docs/user/local-registry/
set -o errexit
...
CLUSTER_NAME=kind  # do not change this, other lines are currently sensitive to this
